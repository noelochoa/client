...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/profile/Edit.vue?vue&type=template&id=f9cff79a&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-page',{staticClass:"mainpage"},[_c('Navigation',_vm._b({},'Navigation',{ opaque: true },false)),_c('div',{staticClass:"edit flex text-grey-8"},[_c('div',{staticClass:"edit-heading text-grey-8"},[_c('router-link',{staticClass:" ls-sm text-uppercase cursor-pointer hover-primary inline-block q-mb-md",attrs:{"tag":"div","to":"/profile"}},[_vm._v("\n        Back to Profile\n      ")]),_c('h4',{staticClass:"text-primary ls-sm"},[_vm._v("Edit Profile")]),_c('p',{staticClass:"text-subtitle1 q-mt-sm"},[_vm._v("Fill out your information below:")]),(_vm.fetching)?_c('q-spinner',{attrs:{"size":"32px","color":"primary"}}):(!_vm.isEmpty(_vm.profile))?_c('q-form',{ref:"edit-form",staticClass:"edit-form",on:{"submit":function($event){$event.preventDefault();$event.stopPropagation();return _vm.onSubmit($event)}}},[(_vm.editErr)?_c('p',{staticClass:"error-msg text-negative bg-red-3 q-py-sm"},[_vm._v("\n          "+_vm._s(_vm.editErr)+"\n        ")]):_vm._e(),_c('q-input',{staticClass:"q-mt-lg",attrs:{"input-class":"text-field","placeholder":"E-mail","type":"email","outlined":"","dense":"","readonly":true},model:{value:(_vm.profile.email),callback:function ($$v) {_vm.$set(_vm.profile, "email", $$v)},expression:"profile.email"}}),_c('q-input',{staticClass:"q-mt-lg",attrs:{"input-class":"text-field","placeholder":"First name","type":"text","outlined":"","dense":"","lazy-rules":"","rules":[
            function (val) { return (val !== null && val.trim() !== '') ||
              'Please enter your first name.'; }
          ]},model:{value:(_vm.profile.firstname),callback:function ($$v) {_vm.$set(_vm.profile, "firstname", $$v)},expression:"profile.firstname"}}),_c('q-input',{staticClass:"q-mt-sm",attrs:{"input-class":"text-field","placeholder":"Last name","type":"text","outlined":"","dense":"","lazy-rules":"","rules":[
            function (val) { return (val !== null && val.trim() !== '') ||
              'Please enter your last name.'; }
          ]},model:{value:(_vm.profile.lastname),callback:function ($$v) {_vm.$set(_vm.profile, "lastname", $$v)},expression:"profile.lastname"}}),_c('q-input',{staticClass:"q-mt-sm",attrs:{"input-class":"text-field","placeholder":"Address","type":"textarea","outlined":"","dense":"","lazy-rules":"","rules":[
            function (val) { return (val !== null && val.trim() !== '') ||
              'Please enter your address.'; }
          ]},model:{value:(_vm.profile.address),callback:function ($$v) {_vm.$set(_vm.profile, "address", $$v)},expression:"profile.address"}}),_c('q-input',{staticClass:"q-mt-sm",attrs:{"input-class":"text-field","placeholder":"Phone (+63) 000-000-0000","type":"text","outlined":"","dense":"","mask":"(+##) ###-###-####","lazy-rules":"","rules":[_vm._isValidPhoneNum]},on:{"input":_vm._syncNotifSetting},model:{value:(_vm.profile.phonenumber),callback:function ($$v) {_vm.$set(_vm.profile, "phonenumber", $$v)},expression:"profile.phonenumber"}}),_c('p',{staticClass:"text-left text-caption q-my-xs"},[_vm._v("\n          Phone number has to be verified before sending SMS.\n        ")]),_c('p',{staticClass:"text-left q-mt-md"},[_vm._v("Order Notifications:")]),_c('q-toggle',{staticClass:"full-width q-pb-xs text-field no-pointer-events",attrs:{"dense":"","disable":"","label":"Receive by Email (Required)","color":"primary"},model:{value:(_vm.profile.notification.isEmailAllowed),callback:function ($$v) {_vm.$set(_vm.profile.notification, "isEmailAllowed", $$v)},expression:"profile.notification.isEmailAllowed"}}),_c('q-toggle',{staticClass:"full-width q-py-xs text-field",attrs:{"dense":"","label":"Receive by SMS","color":"primary","disable":!_vm.profile.phonenumber},model:{value:(_vm.profile.notification.isSMSAllowed),callback:function ($$v) {_vm.$set(_vm.profile.notification, "isSMSAllowed", $$v)},expression:"profile.notification.isSMSAllowed"}}),_c('q-btn',{staticClass:"full-width q-mt-lg submit-btn",attrs:{"loading":_vm.loading,"disable":_vm.loading,"unelevated":"","type":"submit","color":"red-6 ls-sm","size":"16px","padding":"sm lg","label":"Save"}})],1):_vm._e()],1)])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/profile/Edit.vue?vue&type=template&id=f9cff79a&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/profile/Edit.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Editvue_type_script_lang_js_ = ({
  ...
  methods: objectSpread2_default()(objectSpread2_default()({}, Object(vuex_esm["b" /* mapActions */])("auth", ["fetchProfile", "editProfile"])), {}, {
    ...
    async onSubmit() {
      try {
        this.loading = true;
        const resp = await this.editProfile(objectSpread2_default()({}, this.profile));
...
// CONCATENATED MODULE: ./src/pages/profile/Edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var profile_Editvue_type_script_lang_js_ = (Editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/pages/profile/Edit.vue?vue&type=style&index=0&id=f9cff79a&lang=scss&scoped=true&
var Editvue_type_style_index_0_id_f9cff79a_lang_scss_scoped_true_ = __webpack_require__("8469");
...
// CONCATENATED MODULE: ./src/pages/profile/Edit.vue
...
runtime_auto_import_default()(component, 'components', {QPage: QPage["a" /* default */],QSpinner: QSpinner["a" /* default */],QForm: QForm["a" /* default */],QInput: QInput["a" /* default */],QToggle: QToggle["a" /* default */],QBtn: QBtn["a" /* default */]});
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_f9cff79a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b63e");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_f9cff79a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_f9cff79a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_f9cff79a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//# sourceMappingURL=10.d6f50cd8.js.map