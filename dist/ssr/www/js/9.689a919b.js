...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_dda08692_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("001a");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_dda08692_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_dda08692_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_dda08692_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/basket/Index.vue?vue&type=template&id=dda08692&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-page',{staticClass:"mainpage"},[_c('Navigation',_vm._b({},'Navigation',{ opaque: true },false)),_c('div',{staticClass:"basket text-grey-8"},[_c('div',{staticClass:"basket-heading"},[_c('h4',{staticClass:"text-primary text-center ls-sm"},[_vm._v("Your Basket")]),_c('p',{staticClass:"q-mt-lg text-center"},[_vm._v(_vm._s(_vm.fetchErr))])]),(_vm.fetching)?_c('div',{staticClass:"q-mt-lg text-center"},[_c('q-spinner',{attrs:{"size":"50px","color":"primary"}})],1):(_vm.isEmpty(_vm.basket) && !_vm.fetching)?_c('div',{staticClass:"q-mt-lg text-center"},[_c('q-btn',{staticClass:"q-mt-lg",attrs:{"unelevated":"","color":"red-6 ls-sm","size":"16px","padding":"sm lg","label":"Go to Shop","to":"/products"}})],1):_c('div',{staticClass:"basket-details q-mt-lg"},[_c('div',{staticClass:"table-header"},[_c('span',{staticClass:"ls-sm header-item"},[_vm._v("PRODUCT")]),_c('span',{staticClass:"ls-sm header-item"}),_c('span',{staticClass:"ls-sm header-item text-center q-px-sm"},[_vm._v("QTY.")]),_c('span',{staticClass:"ls-sm header-item text-right"},[_vm._v("PRICE")])]),_vm._l((_vm.products),function(item,pidx){return _c('div',{key:'item-' + pidx,staticClass:"table-item text-grey-7"},[_c('div',{staticClass:"product-info product-img"},[_c('q-img',{attrs:{"src":!_vm.isEmpty(item.image)
                ? _vm.resolveAssetsUrl(item.image)
                : 'https://dummyimage.com/370x370/454345/fafafa.png&text=No+Img',"native-context-menu":"","ratio":1}})],1),_c('div',{staticClass:"product-info product-detail ls-sm"},[(item.isActive)?_c('router-link',{staticClass:"text-h6 text-primary product-link ls-sm overflow-ellipsis",attrs:{"to":'/buy/' + item.seoname}},[_vm._v("\n            "+_vm._s(item.name)+"\n          ")]):_c('div',{staticClass:"text-h6 ls-sm overflow-ellipsis"},[_vm._v("\n            "+_vm._s(item.name)+"\n          ")]),_c('div',[_vm._v(_vm._s(item.category))]),_vm._l((item.options),function(opt,idx){return _c('div',{key:'key-' + idx,staticClass:"options"},[_vm._v("\n            "+_vm._s(opt._option + ": " + opt._selected)+"\n            "),(opt.otherValue != null)?_c('span',[_vm._v("("+_vm._s(opt.otherValue)+") ")]):_vm._e(),_c('br')])})],2),_c('div',{staticClass:"product-info text-center"},[_c('q-input',{staticStyle:{"max-width":"140px","margin":"0 auto"},attrs:{"outlined":"","dense":"","value":item.quantity,"input-style":"text-align:center;","debounce":1000},on:{"input":function($event){return _vm.onChgQty($event, pidx)}},scopedSlots:_vm._u([{key:"prepend",fn:function(){return [_c('q-icon',{staticClass:"cursor-pointer",attrs:{"name":"remove"},on:{"click":function($event){return _vm.onChgQty(item.quantity - 1, pidx)}}})]},proxy:true},{key:"append",fn:function(){return [_c('q-icon',{staticClass:"cursor-pointer",attrs:{"name":"add"},on:{"click":function($event){_vm.onChgQty(Number.parseInt(item.quantity) + 1, pidx)}}})]},proxy:true}],null,true)}),_c('q-btn',{staticClass:"ls-sm no-hover-bg hover-primary q-pd-md",attrs:{"flat":"","label":"remove","ripple":false},on:{"click":function($event){return _vm.onRemove(pidx)}}})],1),_c('div',{staticClass:"product-info product-price text-right ls-sm"},[_vm._v("\n          "+_vm._s(item.price)+" PHP\n        ")])])})],2),(!_vm.isEmpty(_vm.basket) && !_vm.fetching)?_c('div',{staticClass:"table-footer"},[_c('div',{staticClass:"footer-item"},[_c('span',{staticClass:"ls-sm text-primary"},[_vm._v("TOTAL: ")]),_c('span',{staticClass:"ls-sm text-primary"},[_vm._v(_vm._s(_vm.total)+" PHP")]),_c('p',[_vm._v("\n          Displayed total have all discounts applied (if any).\n        ")]),_c('q-btn',{attrs:{"unelevated":"","type":"submit","color":"red-6 ls-sm","size":"16px","padding":"sm lg","label":"Checkout","to":"/checkout"}})],1)]):_vm._e()])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/basket/Index.vue?vue&type=template&id=dda08692&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/basket/Index.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/pages/basket/Index.vue?vue&type=script&lang=js&
 /* harmony default export */ var basket_Indexvue_type_script_lang_js_ = (Indexvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/pages/basket/Index.vue?vue&type=style&index=0&id=dda08692&lang=scss&scoped=true&
var Indexvue_type_style_index_0_id_dda08692_lang_scss_scoped_true_ = __webpack_require__("dbaa");
...
// CONCATENATED MODULE: ./src/pages/basket/Index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  basket_Indexvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
runtime_auto_import_default()(component, 'components', {QPage: QPage["a" /* default */],QSpinner: QSpinner["a" /* default */],QBtn: QBtn["a" /* default */],QImg: QImg["a" /* default */],QInput: QInput["a" /* default */],QIcon: QIcon["a" /* default */]});


/***/ })

}]);
//# sourceMappingURL=9.689a919b.js.map